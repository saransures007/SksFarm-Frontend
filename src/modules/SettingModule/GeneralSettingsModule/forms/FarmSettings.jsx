  ...
  const languages = [
    {
      value: 'en',
      label: 'English',
      icon: '🇬🇧', // You can change the icon as per your requirement
    },
    {
      value: 'es',
      label: 'Spanish',
  ...
  return (
    <div style={{direction:langDirection}}>
      ...
      <Form.Item
        ...
        name="sksFarm_app_company_email"
        rules={[
          {
            required: true,
            type: 'email',
